...
w.add(v)
p1=plot.DarcReader([],prefix="both",configdir=configdir,withScroll=1,window=f1, showPlots=0)
p2=plot.DarcReader([],prefix="both",configdir=configdir,withScroll=1,window=f2, showPlots=0)
